...
local theme = getgenv().theme or {
    BackColor = Color3.fromRGB(20, 20, 20),
    TopBar = Color3.fromRGB(25, 25, 25),

    UpperContainer = Color3.fromRGB(30, 30, 30),
    InnerContainer = Color3.fromRGB(35, 35, 35),

    InteractableBackground = Color3.fromRGB(40, 40, 40),
    InteractableOutline = Color3.fromRGB(60, 60, 60),

    Accent = Color3.fromRGB(80, 80, 80), -- Color neutro para hover/selección

    NotSelectedTab = Color3.fromRGB(50, 50, 50),

    TextColor = Color3.fromRGB(255, 255, 255),
    SubTextColor = Color3.fromRGB(180, 180, 180),

    ButtonTop = Color3.fromRGB(35, 35, 35),
    ButtonBottom = Color3.fromRGB(45, 45, 45),
}
