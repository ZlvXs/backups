...
do
	...
	do
		...
		function Library:Watermark(Properties)
			local Watermark = {
				Name = (Properties.Name or Properties.name or "avryhook.club | placeholder");
				AnimateText = nil;
			}
			--
			local Outline = Instance.new("Frame")
			...
			task.spawn(function()
				while task.wait() do
					for i = 1, #"avryhook.club" do
						Watermark.AnimateText = string.sub("avryhook.club", 1, i) .. "";
						Title.Text = Watermark.AnimateText .. " " .. Watermark.Name;
						task.wait(0.4);
					end;

					for i = #"avryhook.club" - 1, 1, -1 do
						Watermark.AnimateText = string.sub("avryhook.club", 1, i) .. "";
						Title.Text = Watermark.AnimateText .. " " .. Watermark.Name;
						task.wait(0.4);
					end;
...
screen_gui.Name = "https://avryhook.club";
...
screen_gui_2.Name = "https://avryhook.club";
...
local target_aim = {}; do
	target_aim.get_predicted_position = function()
		...
		local closest_body_part_enabled = flags["_target_aim_closest_body_part"];
...
do
	...
	do
		...
		instances["local_text"] = utility.instance_new("TextLabel", { 
			Name = "https://avryhook.club",
			Parent = screen_gui_2,
			Text = '<font color="rgb(207, 227, 0)">avrycheap</font><font color="rgb(255, 255, 255)">.club</font>',
...
do
    ...
    do
        ...
        utility.new_connection(run_service.RenderStepped, function()
            ...
            local actual_stutter_amount = (stutter_amount);
    ...
    do
		...
		do
			...
			utility.new_connection(run_service.Heartbeat, function()
				...
				local color = flags["visuals_text_color"];
				...
				if (enabled) then
					...
					local text = custom_text_enabled and '<font color="' .. text_color .. '">' .. features.get_text(custom_text) .. '</font>' or '<font color="' .. text_color .. '">avryhook</font><font color="rgb(255, 255, 255)">.club</font>';
